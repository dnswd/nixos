...
let
  # FOD for npm dependencies (internal let-binding, like pi-listen)
  nodeModules = stdenv.mkDerivation {
    ...
    outputHash = "sha256-VQNjBm9edpLNcwl74NR6+ZZg1glctAxKFuaxiY5vriI=";
...
# Single derivation (like pi-listen) - eliminates runCommand merge indirection
stdenv.mkDerivation rec {
  ...
  src = fetchgit {
    url = "https://github.com/ogulcancelik/pi-extensions.git";
    # NOTE: Upstream has no git tags available (checked 2025-04-05)
    # Using commit hash instead of refs/tags/vX.Y.Z format
    # If tags become available, update to: rev = "refs/tags/v${version}";
    rev = "d4e61c0a8be814c465b9224b26f05a0310c94d7a";
    hash = "sha256-yErbEG9KJ+azEoLYEkz0yxZ3mb1SzRTabv8Op3rPxP8=";
  };
  ...
  installPhase = ''
    ...
    # 3. Write extension/index.ts with placeholder (was: writeTextFile let-binding)
    cat > $out/lib/pi-web-browse/extension/index.ts << 'EXTEOF'
import { Type } from "@sinclair/typebox";
import type { ExtensionAPI, ExtensionContext } from "@mariozechner/pi-coding-agent";
import { spawn } from "node:child_process";

const WEB_BROWSE_PATH = "@@WEB_BROWSE_PATH@@";
...
EXTEOF
    ...
    sed -i "s|@@WEB_BROWSE_PATH@@|$out/lib/pi-web-browse/web-browse.js|g" \
      $out/lib/pi-web-browse/extension/index.ts

    # 4. Write extension/package.json (was: writeTextFile let-binding)
    cat > $out/lib/pi-web-browse/extension/package.json << 'JSONEOF'
{
  "name": "pi-web-browse",
  "version": "1.0.5",
  "private": true,

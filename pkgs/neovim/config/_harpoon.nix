...
in {
  ...
  keymaps  = [
    (mkLuaKeymap "n" "<leader>a" /* lua */ ''require("harpoon.mark").add_file''                 "Add file to harpoon")
    (mkLuaKeymap "n" "<C-e>"     /* lua */ ''require("harpoon.ui").toggle_quick_menu''          "Toggle harpoon menu")
    # File maps

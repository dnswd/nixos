...
/**
 * Generate a URL for a fixture file.
 * @param serverUrl - The fixture server URL (e.g., from FixtureServer.url)
 * @param filename - The fixture filename (e.g., 'network-page.html')
 * @returns Full URL to the fixture
 */
export function fixtureUrl(serverUrl: string, filename: string): string {
